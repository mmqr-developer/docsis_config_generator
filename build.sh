...
# Build the DOCSIS configuration-file encoder with the build time compiled in.
#
...
# 3. The default test set, as musl binaries. The regression corpus takes about a minute: every
#    fixture is encoded, decoded and re-encoded against golden files from
